                                ...
                                <div className={styles.card} key={index}>
                                    ...
                                    {showCommentPart[item.News] ? (
                                        <div className={styles.CommentPart}>
                                            <textarea id={`subject-${item.News}`} name="subject" placeholder="tapez votre commentaire.." style={{ height: '100px', fontSize: '11px' }}></textarea>
                                        ...
                                        <div className={styles.card_button}>
                                            ...
                                            <div className={styles.CB_reactions}>
                                                ...
                                                <div style={{ paddingRight: '5px' }}>
                                                    <button className={styles.CB_reactions_BTN} onClick={() => handleToggleCommentPart(item.News)}>Comment</button>
                                                </div>
                                            </div>
                                        </div>
                                    )}
